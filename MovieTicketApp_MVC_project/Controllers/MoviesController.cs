...
namespace MovieTicketApp_MVC_project.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var appDbContext = _context.Movies.Include(m => m.Cinema).Include(m => m.Producer).OrderBy(m=>m.Name);
        ...
        public IActionResult Create()
        {
            ...
            var enumValues = Enum.GetValues(typeof(MovieCategory)).Cast<MovieCategory>().Select(e => new { Value = e.ToString(), Text = e.ToString() }).ToList();
            ViewData["MovieCategory"] = new SelectList(enumValues, "Value", "Text","");
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,ImageURL,StartDate,EndDate,MovieCategory,CinemaId,ProducerId")] Movie movie)
        {
            ...
            var enumValues = Enum.GetValues(typeof(MovieCategory)).Cast<MovieCategory>().Select(e => new { Value = e.ToString(), Text = e.ToString() }).ToList();
            ViewData["MovieCategory"] = new SelectList(enumValues, "Value", "Text", "",movie.MovieCategory.ToString());
